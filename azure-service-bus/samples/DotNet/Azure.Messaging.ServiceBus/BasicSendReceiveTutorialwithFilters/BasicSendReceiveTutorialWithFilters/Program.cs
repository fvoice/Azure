...
namespace BasicSendReceiveTutorialWithFilters
{
    class Program
    {
        ...
        static Program StartProgram()
        {
            var program = new Program
            {
                ServiceBusConnectionString = "Endpoint=sb://fvoice.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=cFTnKpB5lO61rFZzjoM4Ddjgy1e1sk7Ks7DWAmvV4Ek=",
                TopicName = "events"
            };
